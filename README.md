...
**_🎯 Problematização 1: Aula Expositiva_**

**Modernização do Sistema de Streaming GamerFlix**

_Contexto:_

- O GamerFlix é uma plataforma de streaming de jogos que virou febre entre os jovens. Com o sucesso, eles precisam atualizar constantemente seu banco de dados.

```sql
CREATE DATABASE gamerflixdb;

CREATE TABLE usuarios ( -- Dados iniciais - Usúarios
...
INSERT INTO usuarios (username, email, pontos, data_cadastro) -- Colocando valores na tabela usúarios
VALUES
